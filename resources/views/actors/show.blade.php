    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                ...
                <img src="{{ $actor['profile_path'] }}" alt="profile_image" class="w-76 md:w-96">
                    ...
                    @if ($social['facebook'])
                        <li>
                            <a href="{{ $social['facebook'] }}" title="Facebook">
                                ...
                                <svg class="fill-current text-gray-400 hover:text-gray w-6" viewBox="0 0 448 512">
                                    <path
                    ...
                    @if ($social['twitter'])
                        ...
                        <li class="ml-6">
                            <a href="{{ $social['twitter'] }}" title="Twitter">
                                ...
                                <svg class="fill-current text-gray-400 hover:text-gray w-6" viewBox="0 0 512 512">
                                    <path
                    ...
                    @if ($actor['homepage'])
                        <li class="ml-6">
                            <a href="{{ $actor['homepage'] }}" title="Homepage">
                                ...
                                <svg class="fill-current text-gray-400 hover:text-gray w-6" viewBox="0 0 496 512">
                                    <path
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    <svg class="fill-current text-gray-400 hover:text-gray w-4" viewBox="0 0 448 512">
                        <path
                    ...
                    <span class="ml-2 mt-1">{{ $actor['birthday'] }} ( {{ $actor['age'] }} years old ) in
                        ...
                        <div class="mt-4">
                            ...
                            <a href="{{ $movie['linkToPage'] }}"><img src="{{ $movie['poster_path'] }}" alt="poster"
                                ...
                                <a href="{{ $movie['linkToPage'] }}"
                                    class="text-sm leading-normal block text-gray-400 hover:text-gray mt-1">
                                    {{ $movie['title'] }}
                                </a>
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-2">
                        ...
                        <link
                            ...
                            rel="stylesheet">
                        <div class="flex items-center mt-10 mx-auto min-h-screen bg-gray-900">
                                                    ...
                                                    <td class="p-3">
                                                        <div class="flex align-items-center">
                                                            <img class="rounded-full h-12 w-12  object-cover"
                                                                src="{{ $credit['poster_path'] }}" alt="unsplash image">
                                                            <div class="ml-3">
                                                                <div class="text-white">{{ $credit['release_year'] }}
                                                                </div>
                                                                <div class="text-white">{{ $credit['title'] }}</div>
                                                            </div>
                                                        </div>
                                                    </td>
